...
See [load test ramping configurations]({{ site.baseurl }}{% link _nextgen/test-scripting/load-test-ramping-configurations.md %}) for more examples.

## Specifying from which load zones to generate traffic

When running a cloud execution test you can configure from which load zones the traffic should be generated. See the [cloud execution]({{ site.baseurl }}{% link _nextgen/test-running/cloud-execution.md %}) article for more information.
...
See the dedicated article about [thresholds]({{ site.baseurl }}{% link _nextgen/test-scripting/thresholds.md %}) for more information.
