...
![example 1](jekyll/assets/img/legacy/quick-start-guide/analyze-interpret-results/analyze-interpret-results-1.png)
...
### Example results 2:
![example 2](jekyll/assets/img/legacy/quick-start-guide/analyze-interpret-results/analyze-interpret-results-2.png)
...
### Example results 3:
![example 3](jekyll/assets/img/legacy/quick-start-guide/analyze-interpret-results/analyze-interpret-results-3.png)
