...
![Google Analytics Example]({{ site.baseurl }}/jekyll/assets/img/legacy/test-configuration/calculating-the-number-of-virtual-users-to-test/calculating-the-number-of-virtual-users-to-test-1.png)

And that’s it! As you can see, Google made this data pretty easy to find.

### How to design your load test

One good way of determining what traffic to subject your site to during a load test is to check your peak hours of traffic in Google Analytics, figure out how many sessions you faced then, and perform a test that generates a similar kind of load in a similar [pattern]({{ site.baseurl }}/legacy/test-configuration/load-test-ramping-configurations/). You probably want to add some margin to it also — to ensure that you can handle higher traffic levels than your latest peak.
...
![Google Analytics Example #2]({{ site.baseurl }}/jekyll/assets/img/legacy/test-configuration/calculating-the-number-of-virtual-users-to-test/calculating-the-number-of-virtual-users-to-test-2.png)
...
![Google Analytics Example #3]({{ site.baseurl }}/jekyll/assets/img/legacy/test-configuration/calculating-the-number-of-virtual-users-to-test/calculating-the-number-of-virtual-users-to-test-3.png)
...
- [User scenario]({{ site.baseurl }}/legacy/user-scenarios/)
- [User scenario scripting] ({{ site.baseurl }}/legacy/user-scenario-scripting-examples/)
- [Test configuration]({{ site.baseurl }}/legacy/test-configuration/what-is-a-test-configuration/)
