...
![Google Analytics Example]({{ site.baseurl }}assets/img/legacy/test-configuration/calculating-the-number-of-virtual-users-to-test/calculating-the-number-of-virtual-users-to-test-1.png)
...
![Google Analytics Example #2]({{ site.baseurl }}/assets/img/legacy/test-configuration/calculating-the-number-of-virtual-users-to-test/calculating-the-number-of-virtual-users-to-test-2.png)
...
![Google Analytics Example #3]({{ site.baseurl }}/assets/img/legacy/test-configuration/calculating-the-number-of-virtual-users-to-test/calculating-the-number-of-virtual-users-to-test-3.png)
